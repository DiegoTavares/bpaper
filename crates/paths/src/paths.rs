...
/// On macOS, this is `~/Library/Application Support/Thock`.
/// On Linux/FreeBSD, this is `$XDG_DATA_HOME/thock`.
/// On Windows, this is `%LOCALAPPDATA%\Thock`.
static CURRENT_DATA_DIR: OnceLock<PathBuf> = OnceLock::new();

/// The resolved config directory, combining custom override or platform defaults.
/// This is set once and cached for subsequent calls.
/// On macOS, this is `~/.config/thock`.
/// On Linux/FreeBSD, this is `$XDG_CONFIG_HOME/thock`.
/// On Windows, this is `%APPDATA%\Thock`.
